<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Account/Admin_Master.master" AutoEventWireup="true" CodeFile="Modify_Magazine.aspx.cs" Inherits="Admin_Account_Modify_Magazine" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
     ...
     <div style="height: 396px">
        ...
        <table class="style1">
         ...
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCS %>" DeleteCommand="DELETE FROM [tblUploadMagazine] WHERE [ID] = @ID" InsertCommand="INSERT INTO [tblUploadMagazine] ([MName], [PName], [IssueNo], [DateOfIssue], [Category], [PSchedule], [Ptype], [Keywords]) VALUES (@MName, @PName, @IssueNo, @DateOfIssue, @Category, @PSchedule, @Ptype, @Keywords)" SelectCommand="SELECT [ID], [MName], [PName], [IssueNo], [DateOfIssue], [Category], [PSchedule], [Ptype], [Keywords] FROM [tblUploadMagazine] WHERE ([MName] LIKE '%' + @MName + '%')" UpdateCommand="UPDATE [tblUploadMagazine] SET [MName] = @MName, [PName] = @PName, [IssueNo] = @IssueNo, [DateOfIssue] = @DateOfIssue, [Category] = @Category, [PSchedule] = @PSchedule, [Ptype] = @Ptype, [Keywords] = @Keywords WHERE [ID] = @ID">
           
             <SelectParameters>
                 <asp:ControlParameter ControlID="txtSearch" Name="MName" PropertyName="Text" Type="String" />
             </SelectParameters>
             <UpdateParameters>
         ...
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="ID" DataSourceID="SqlDataSource1">
             <Columns>
                 ...
                 <asp:BoundField DataField="MName" HeaderText="Magazine Name" SortExpression="MName" />
                 <asp:BoundField DataField="PName" HeaderText="Publisher's Name" SortExpression="PName" />
